        ...
        public void SyncFTPMainMethod()
        {
            try
            {
                ...
                SessionOptions sessionOptions = new SessionOptions
                {
                    ...
                    HostName = Helpers.Global.FtpHostName,
                    PortNumber = Helpers.Global.FtpPort,
                    UserName = Helpers.Global.FtpUser,
                    Password = Helpers.Global.FtpPassword,
                ...
                using (Session session = new Session())
                {
                    ...
                    string ftpCustomer = Helpers.Global.FtpCustomer;
                    string ftpLocation = Helpers.Global.FtpLocation;
